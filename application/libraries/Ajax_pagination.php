...
//        }
    ...
    function my_link_to_remote($url, $text, $div, $pars=array()){
        ...
        $html = "<li><a href='javascript:page_click(".$v.")'>$text</a></li>";
       
        // $html = "<li><a href='' onclick='new Ajax.Updater(\"$div\",\"$url\",{method: \"post\", parameters:{\"page\":\"$v\"}, evalScripts:true});return false;'>$text</a></li>";
        else:
        $html = "<li><a href='javascript:page_click(0)'>$text</a></li>";
        // $html = "<li><a href='' onclick='new Ajax.Updater(\"$div\",\"$url\",{method: \"post\", evalScripts:true}); return false;' >$text</a></li>";
        endif;
    return $html;
    }
}
