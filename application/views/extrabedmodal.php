...
<div class="modal-dialog" style="overflow-y:auto;height: 100%;width: 55%;">
  <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" id="add_extrabed" name="add_extrabed" enctype="multipart/form-data"> 
        ...
        <div class="row">
          ...
          <div class="form-group col-md-4">
              ...
              <input type="text"  class="datePicker-hide datepicker" id="fromDate" name="fromDate" readonly="" placeholder="dd/mm/yyyy" value="<?php echo isset($id) ? $extrabed[0]->from_date : '' ?>" >
              <div class="input-group">
                  <input class="datepicker form-control" id="alternate1" readonly="" value="<?php echo isset($id) && $extrabed[0]->season=="Other" ? date('d/m/Y' ,strtotime($extrabed[0]->from_date)) : '' ?>" >
          ...
          <div class="form-group col-md-4">
              <label>To Date</label>
              <input type="text"  class="datePicker-hide datepicker" id="toDate" name="toDate" readonly="" placeholder="dd/mm/yyyy" value="<?php echo isset($id) ? $extrabed[0]->to_date : '' ?>" >
              <div class="input-group">
                  <input class="datepicker form-control" id="alternate2" readonly="" value="<?php echo isset($id) && $extrabed[0]->season=="Other" ? date('d/m/Y' ,strtotime($extrabed[0]->to_date)) : '' ?>" >
        ...
        <div class="row">
          <div class="form-group col-md-4">
                ...
                <input type="number"  class="form-control" id="ChildAgeFrom" name="ChildAgeFrom" value="<?php echo isset($id) ? $extrabed[0]->ChildAgeFrom : '' ?>" >
                <p class="text-danger er-msg hide ChildAgeFrom-err">required</p>
            </div>
            <div class="form-group col-md-4">
                <label>Child age to</label>
                <input type="number"   class="form-control" id="ChildAgeTo" name="ChildAgeTo" value="<?php echo isset($id) ? $extrabed[0]->ChildAgeTo : '' ?>" >
                <p class="text-danger er-msg hide ChildAgeTo-err">required</p>
            </div>
            <div class="form-group col-md-4">
                <label>Child amount</label>
                <input type="number"   class="form-control" id="ChildAmount" name="ChildAmount" value="<?php echo isset($id) && $extrabed[0]->ChildAmount!="" ? $extrabed[0]->ChildAmount : '' ?>" >
        ...
        <div class="row">
          <div class="form-group col-md-4">
              ...
              <input type="number" class="form-control" min="0" name="Amount" id="Amount" value="<?php echo isset($id) && $extrabed[0]->amount!="" ? $extrabed[0]->amount : '' ?>">
                <p class="text-danger er-msg hide Amount-err">required</p>
          </div>
        </div>
        </form>
      </div>
       <div class="modal-footer">
        <?php if(isset($id) && $id!="") { ?>
          <button type="button" class="btn-sm btn-success" name="extrabed_submit" id="extrabed_submit">Update</button>
        <?php } else { ?>
            <button type="button" class="btn-sm btn-success" name="extrabed_submit" id="extrabed_submit">Submit</button> 
        <?php } ?>
...
<script type="text/javascript">
  ...
  $(document).ready(function() {
   var nextDay = new Date($("#date_picker1").val());
    ...
    $("#extrabed_submit").click(function() {
      $(".er-msg").addClass("hide");
      $.ajax({
          dataType: 'json',
          type: "Post",
          url: base_url+'HotelSupplier/extrabedsubmit',
          data: $("#add_extrabed").serialize(),
          success: function(data) {
            if (data['status']=="failed") {
              ...
              $("#extrabed_submit").prop("disabled",true);
              $(".close").trigger("click");
              ...
              var extrabed_table = $('#extrabed_table').dataTable({
                "bDestroy": true,
                "ajax": {
                    url : base_url+'HotelSupplier/extrabedlist/<?php echo $contractid ?>',
                    type : 'GET'
                },
